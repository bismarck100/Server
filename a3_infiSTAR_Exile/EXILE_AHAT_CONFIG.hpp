...
class adminNameTags {
	...
	//Storm - 76561198032057910
	//Peter - 76561198051174369
	//Chimpa - 76561198000172302
	//Jason - 76561198139422243
	//Crisos - 76561198151071704
	//Ked - 76561198007541000
	//Erica - 76561198009481451
	//Van - 76561197960289679
	//Reeds - 76561197971407766
	//Skeg - 76561198162513363
	//Patrick - 76561198246513552
	//Karel - 76561197970332520
	//Cpt.Friendly - 76561198015648486
    //Delta - 76561197993515954
	//Dicky - 76561198169158687
...
hiddenSuperAdmin[] =
{
	"76561198139422243","76561198000172302","76561197970332520","76561198022731756"
};

adminUIDandAccess[] =
{
	{
		{"76561197960289679","76561198246513552","76561198048671871","76561197993515954","76561198169158687"},	/* Admins with UIDs in this Array have their Access defined in the array below. */
		{
			...
			"God Mode","God Mode (no stats change)","Vehicle God Mode","Zombie Shield","Lower Terrain","Vehboost","UnlimAmmo","noRecoil","FastFire","Stealth / Invisible",
...
NOTIFY_MSG_ARRAY[] =
{
	{-1, -1, 6, 0.6, 0, 0, "#ff0000", "OrbitronLight", "Welcome to Redemption Gaming"},
	{-1, -1, 4, 0.6, 0, 0, "#1900FF", "OrbitronLight", "Enjoy your stay!"},
	{-1, 45, 5, 0.6, "safeZoneX", "0.5", "#048B5B", "OrbitronLight", "Check out our forums<br/>redemptiongaming.enjin.com, Join us on Discord<br/>discordapp.com/invite/7ZNeDhh"},
	{-1, 20, 10, 0.36, -0.7, 0.84, "#e5e5e5", "PuristaMedium","Our Admins Team<br/>TheChimpa<br/>JasonPrice<br/>Delta<br/>Patrick<br/>VanThunderBeef"}
};
...
BAN_GLOBAL_BANNED_LOCALLY = "true";	/* if false, it will kick global banned people */
...
DayNightVote = "true";
MRV = 0.50;	/* if "DayNightVote = "true";" - Minimum votes required. Percentage of players needed to pass the vote. */
MVP = 0.60;	/* if "DayNightVote = "true";" - Minimum vote percentage. A setting that dictates the minimum vote percentage that needs to be reached for the vote to pass. */
...
LogPopTabIncrease = 300000;			/* Only if checkPopTabIncrease = "true"; logs if PopTabs increased by x within ~50 seconds */
BanPopTabIncrease = 4000001;			/* Only if checkPopTabIncrease = "true"; bans a player if PopTabs increase by more than x within ~50 seconds */
...
badNamesPartial[] = {"admin","adolf","nigger","nigga","niga","niggar","hitler"};
...
badGroupNames[] = {"admin","adolf","nigger","nigga","niga","niggar","hitler"};
...
blacklistedVariables[] =
{
	...
	"sni_prz_zzz_targetplayer","healit","o_fnc_arma","mlrn_exec","running_threads","catchemall10244","killtarget","gmtoggle","t1","fuck_me_keyp","cheatcurator"
};
...
{
	{
		"Starter Box",
		{
			"Exile_Item_Flag","Exile_Melee_Axe","Exile_Item_Handsaw",
			{"Exile_Item_Codelock",1},{"Exile_Item_SafeKit",1},{"Exile_Item_WoodFloorKit",2},{"Exile_Item_WoodDoorKit",1},
	...
	},
	{
		"Small Building Kit",
		{
			"Exile_Item_Flag","Exile_Melee_Axe","Exile_Item_Handsaw","Exile_Item_Laptop","Exile_Item_CampFireKit",
			{"Exile_Item_WoodDoorKit",5},{"Exile_Item_WoodDoorwayKit",5},{"Exile_Item_BaseCameraKit",4},
			{"Exile_Item_WoodFloorKit",20},{"Exile_Item_WoodFloorPortKit",5},{"Exile_Item_WoodGateKit",4},
			{"Exile_Item_WoodStairsKit",8},{"Exile_Item_WoodPlank",100},
			{"Exile_Item_WoodSupportKit",10},{"Exile_Item_WoodWallHalfKit",10},{"Exile_Item_WoodWallKit",25},
			{"Exile_Item_WoodWindowKit",8},{"Exile_Item_WorkBenchKit",1}
		}
	},
	{
		"Large Building Kit",
	...
	},
	{
		"Custom Building Kit",
		{
			{"Exile_Item_ConcreteFloorKit",30},{"Exile_Item_ConcreteFloorKit",30},{"Exile_Item_MetalScrews",10}
		}
	},
	{
		"Minecraft-Box",
		{
			{"Exile_Item_FuelCanisterEmpty",100},{"Exile_Item_FuelCanisterFull",100},{"Exile_Melee_Axe",100},
			{"Exile_Item_ZipTie",100},{"Exile_Item_ScrewDriver",100},{"Exile_Item_Pliers",100},
			{"Exile_Item_Handsaw",100},{"Exile_Item_JunkMetal",100},{"Exile_Melee_Shovel",100},
			{"Exile_Item_WaterCanisterEmpty",100},{"Exile_Item_DuctTape",100},{"Exile_Item_LightBulb",100},
			{"Exile_Item_ExtensionCord",100},{"Exile_Item_MetalScrews",100},{"Exile_Item_Grinder",100},
			{"Exile_Item_MetalWire",100},{"Exile_Melee_SledgeHammer",100},{"Exile_Item_CamoTentKit",100},
			{"Exile_Item_Foolbox",100},{"Exile_Item_Sand",100},{"Exile_Item_MetalBoard",100},
			{"Exile_Item_PortableGeneratorKit",100},{"Exile_Item_Cement",100},{"Exile_Item_Knife",100},
			{"Exile_Item_FloodLightKit",100},{"Exile_Item_Magazine04",100},{"Exile_Item_Laptop",100},
			{"Exile_Item_BaseCameraKit",100},{"Exile_Item_Flag",100},{"Exile_Item_Vishpirin",100},
			{"Exile_Item_Bandage",100},{"Exile_Item_InstaDoc",100},{"Exile_Item_ConcreteDoorKit",100},
			{"Exile_Item_ConcreteDoorwayKit",100},{"Exile_Item_MetalHedgehogKit",100},{"Exile_Item_RepairKitWood",100},
			{"Exile_Item_ConcreteFloorKit",100},{"Exile_Item_ConcreteFloorPortKit",100},{"Exile_Item_ConcreteWindowKit",100},
			{"Exile_Item_ConcreteGateKit",100},{"Exile_Item_ConcreteWallKit",100},{"Exile_Item_ConcreteSupportKit",100},
			{"Exile_Item_FortificationUpgrade",100},{"Exile_Item_HBarrier5Kit",100},{"Exile_Item_RepairKitMetal",100},
			{"Exile_Item_RepairKitConcrete",100},{"Exile_Item_SandBagsKit_Corner",100},{"Exile_Item_SandBagsKit_Long",100},
			{"Exile_Item_WoodDoorKit",100},{"Exile_Item_WoodDoorwayKit",100},{"Exile_Item_WoodFloorKit",100},
			{"Exile_Item_WoodFloorPortKit",100},{"Exile_Item_WoodWindowKit",100},{"Exile_Item_WoodGateKit",100},
			{"Exile_Item_WoodWallKit",100},{"Exile_Item_WoodSupportKit",100},{"Exile_Item_WaterBarrelKit",100},
			{"Exile_Item_StoragecrateKit",100},{"Exile_Item_CampFireKit",100},{"Exile_Item_WoodWallHalfKit",100},
			{"Exile_Item_WorkBenchKit",100},{"Exile_Item_WoodLog",100},{"Exile_Item_WoodPlank",100},{"Exile_Item_WoodDrawBridgeKit",100}
