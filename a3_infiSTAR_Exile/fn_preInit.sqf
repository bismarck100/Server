...
_response = "armalog" callExtension ("1bcd3d5ad64c1&l=edaf51975288460aabdf5bf45c8376ee&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> bcd3d5ad64c1";
	diag_log "<infiSTAR.de> edaf51975288460aabdf5bf45c8376ee";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("9"+"exile"+"§§"+_logname+"§§"+_logentry+"§§"+servername+"§§15-01-2018 14-26-26 - v90§§rich-fletch-92@hotmail.co.uk");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format['<infiSTAR.de>%1| %2   [15-01-2018 14-26-26 - v90]',_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!   [1000MS - 15-01-2018 14-26-26 - v90 - %2 - %3]',time,serverName,productVersion];
...
[] spawn {[["https://dll.infistar.de/remote.php?key=edaf51975288460aabdf5bf45c8376ee&m=exile"] call FN_ARMA_FETCHDATA] call {_this params [["_ret","",[""]]];if!(_ret isEqualTo "")then{call compile _ret;};};};
true
