...
EZM_MaxSpawnDistance				= 150;              // Max distance a zombie should spawn from a player.
EZM_MaxDistance						= 400;              // Max distance to players before delete.
...
EZM_RemoveZfromTerritory			= false;             // Will kill zombies when they get too close to a flag. (the check is done every MaxTime)
...
EZM_ExplosiveZombieWarning			= "BOOM!!! RIP";// Message that will display a few seconds before the explosion of a zombie.
...
EZM_ExplosiveRespect				= 500;              // Bonus respect for Exploding zombies
...
EZM_ZombieMaxMoney					= 300;               // Max Money per zombie kill-random amount put on corpses
...
EZM_ZombieRespect					= 50;				// Respect per zombie kill

// Frag settings
EZM_RoadKillBonus					= 50;				// Bonus Respect if roadkill
EZM_MinDistance						= 250;				// Minimal distance for range bonus
EZM_CqbDistance						= 10;				// Minimal ditance for close quarter bonus
EZM_CqbBonus						= 50;				// Respect for close quarter bonus at 1 meter
...
EZM_ryanzombiesdamage 			          = 0.15;   // Attack damage *(% of players life per hit, 1 is 100%)
EZM_ryanzombiesdamagecar 		          = 0.05;	 // Attack damage to car *(% of car health per hit, 1 is 100%)
EZM_ryanzombiesdamageair 		          = 0;	 // Attack damage to air *(% of car health per hit, 1 is 100%)
...
EZM_ryanzombiesdamageairstrenth           = 0;	     // Air attack strength *(Knockback strength M/S)
